    ...
    return (
      <section id="join" className="flex flex-col lg:flex-row gap-y-12 justify-between items-center pt-10 pb-16 mb-24 transition-all duration-700 ease-in-out">
            ...
            <div className="w-full lg:w-1/2 flex flex-row items-center gap-x-5 lg:justify-end">
                <Link to="" className="bg-teal text-white border-2 border-teal hover:text-teal hover:bg-transparent hover:border-teal font-semibold py-2 px-3 rounded-md  transition ease-in-out delay-50 duration-500">Jalin Kerjasama</Link>
                <Link to="" className="bg-transparent text-teal border-2 border-teal hover:bg-teal hover:text-white font-semibold py-2 px-3 rounded-md  transition ease-in-out delay-50 duration-500">Buat Kampanye</Link>
            </div>
        </section>
    );
  }
